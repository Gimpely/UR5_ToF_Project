...
def write_2_csv(data):
    cas = datetime.now()
    with open("/home/student/Desktop/UR_test_ws/src/ur5-joint-position-control/src/src/my_code/lidar_data/lidar_data_A2.csv",'a') as myfile:
...
pub_A2_sim = rospy.Publisher('A2_sim', Int32, queue_size=10)
