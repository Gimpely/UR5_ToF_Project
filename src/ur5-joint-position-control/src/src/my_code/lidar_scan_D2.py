...
def write_2_csv(data):
    cas = datetime.now()
    with open("/home/student/Desktop/UR_test_ws/src/ur5-joint-position-control/src/src/my_code/lidar_data/lidar_data_D2.csv",'a') as myfile:
...
ts = message_filters.ApproximateTimeSynchronizer([D2], 1, 1)
ts.registerCallback(callback)
pub_D2_sim = rospy.Publisher('D2_sim', Int32Stamped, queue_size=10)
