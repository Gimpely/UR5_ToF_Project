...
def arrange_4_4(samples,data):
    ...
    # plt.show()
     ...
     # Reshape the masked data into 4x4 blocks
    reshaped_masked_data = masked_data.reshape(-1, samples // 4, samples // 4)

    # Flatten the reshaped masked data
    arranged_array = reshaped_masked_data.flatten()
